...
const plane = new THREE.Mesh(
    ...
    new THREE.MeshStandardMaterial({
        map: textureLoader.load('Bricks/BricksLongThinRunningExtruded001_COL_1K_METALNESS.png'),
        aoMap: textureLoader.load('Bricks/BricksLongThinRunningExtruded001_AO.png'),
        normalMap: textureLoader.load('Bricks/BricksLongThinRunningExtruded001_NRM_1K_METALNESS.png'),
        roughnessMap: textureLoader.load('Bricks/BricksLongThinRunningExtruded001_ROUGHNESS_1K_METALNESS.png'),
        bumpMap: textureLoader.load('Bricks/BricksLongThinRunningExtruded001_BUMP_1K_METALNESS.png'),
        displacementMap: textureLoader.load('Bricks/BricksLongThinRunningExtruded001_DISP_1K_METALNESS.png'),
        metalnessMap: textureLoader.load('Bricks/BricksLongThinRunningExtruded001_METALNESS_1K_METALNESS.png'),
        idmap: textureLoader.load('Bricks/BricksLongThinRunningExtruded001_IDMAP_1K_METALNESS.png'),
